# word vector space (cuda)

A python module that helps in loading and performing operations on word vector spaces created using Google's Word2vec tool over GPU
...
# Run doctest
python -m doctest -v cuda_wordvecspace.py
```
